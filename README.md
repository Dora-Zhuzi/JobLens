...
> 下面为占位图，替换 `screenshots/` 下的同名文件即可。

| 岗位详情编辑 + 匹配度 | AI 结构化 / 自动拆解 |
| :---: | :---: |
| ![编辑页](screenshots/01-editor.png) | ![结构化对比](screenshots/02-decompose.png) |

| 岗位列表（排序 / 多选） | 岗位要求统计排行榜 |
| :---: | :---: |
| ![岗位列表](screenshots/03-list.png) | ![统计](screenshots/04-stats.png) |

| 创建 / 批量上传（OCR） |
| :---: |
| ![上传](screenshots/05-upload.png) |
